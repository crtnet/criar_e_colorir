...
const SAFE_PROMPTS: Record<ImageCategory, string[]> = {
  ...
  vehicles: [
    ...
    'fire truck with ladder, star badge, clouds and sparkles',
    'school bus with windows, road lines and small stars',
    'rocket blasting off, clouds and stars, moon in corner'
  ],
  food: [
  ...
  private static getFallbackImage(category: ImageCategory): ColoringImage {
    const fallbackImages: Record<ImageCategory, ColoringImage> = {
      animals: {
        ...
        thumbnailUrl: '/images/fallback/cat-thumb.svg',
        isAIGenerated: false,
        isApproved: true,
        createdAt: new Date(),
      ...
      nature: {
        ...
        thumbnailUrl: '/images/fallback/flower-thumb.svg',
        isAIGenerated: false,
        isApproved: true,
        createdAt: new Date(),
      ...
      shapes: {
        ...
        thumbnailUrl: '/images/fallback/circle-thumb.svg',
        isAIGenerated: false,
        isApproved: true,
        createdAt: new Date(),
      ...
      characters: {
        ...
        thumbnailUrl: '/images/fallback/robot-thumb.svg',
        isAIGenerated: false,
        isApproved: true,
        createdAt: new Date(),
      ...
      vehicles: {
        ...
        category: 'vehicles',
        difficulty: 'easy',
        imageUrl: '/images/fallback/car-outline.svg',
        thumbnailUrl: '/images/fallback/car-thumb.svg',
        isAIGenerated: false,
        isApproved: true,
        createdAt: new Date(),
      ...
      food: {
        ...
        thumbnailUrl: '/images/fallback/apple-thumb.svg',
        isAIGenerated: false,
        isApproved: true,
        createdAt: new Date(),
      ...
      toys: {
        ...
        thumbnailUrl: '/images/fallback/teddy-thumb.svg',
        isAIGenerated: false,
        isApproved: true,
        createdAt: new Date(),
      ...
      fantasy: {
        ...
        thumbnailUrl: '/images/fallback/unicorn-thumb.svg',
        isAIGenerated: false,
        isApproved: true,
        createdAt: new Date(),
